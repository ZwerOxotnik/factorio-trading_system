...
local options = {
	...
	chunkname = "models/trading_system.can", -- the chunkname used when running code using the helper functions and writing the line origin comments. Candran will try to set it to the original filename if it knows it.
...
candran_to_lua("./models/trading_system.can", "./models/trading_system-extra-stability.lua")
options.preprocessorEnv = {DEBUG = true}
candran_to_lua("./models/trading_system.can", "./models/trading_system-debug.lua")
options.preprocessorEnv = {}
candran_to_lua("./models/trading_system.can", "./models/trading_system-stable.lua")
